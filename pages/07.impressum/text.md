...
untertitel: "Angaben gemäß Mediengesetz und Informationen zum Datenschutz."
---

## Impressum

**EEG Bruck an der Glocknerstraße und Pinzgauer Zentralraum**
Erneuerbare-Energie-Gemeinschaft (gemeinnütziger Verein)
Bruck an der Glocknerstraße, Salzburg, Österreich
...
Wir nehmen den Schutz Ihrer persönlichen Daten ernst. Personenbezogene Daten werden auf
dieser Website nur im technisch notwendigen Umfang erhoben.

- **Kontaktformular:** Die von Ihnen eingegebenen Daten (Name, E-Mail, Nachricht) werden
  ausschließlich zur Bearbeitung Ihrer Anfrage verwendet und nicht an Dritte weitergegeben.
- **Energieverbrauchsdaten** von Mitgliedern (Zählpunkte, Verbrauch) gelten als sensibel
  und werden vertraulich sowie DSGVO-konform behandelt.
